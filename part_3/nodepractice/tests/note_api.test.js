...
const { initialNotes, initialUsers } = helper
...
describe('addition of a new note', () => {
    test('a valid note can be added', async () => {
        ...
        const usersNoteAdedd = usersAtEnd[1]
        expect(usersNoteAdedd.notes).toHaveLength(1)

    })

    test('fails with status code 400 is data is invalid', async () => {
        const newNote = {
            important: false
        }
